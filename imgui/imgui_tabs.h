...
namespace ImGui
{
	...
	IMGUI_API   bool          TabButton(char* tabname, int index);
	IMGUI_API   int          TabButtonGIndex();
	IMGUI_API	bool TabButtonEx(const char* label, const ImVec2& size_arg, int flags, bool selected);
...
namespace ImGui
{
	...
	IMGUI_API void StyleColorsMaze();
	IMGUI_API void SexyCheckBox(char *checkboxtext, int index, bool &controller, ImVec4 &colorcontroller, ImVec4 &colorcontroller2);
